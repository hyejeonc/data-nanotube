...
axs[0].plot(d[:,0], d[:,1], label = 'in+out', color = 'black', linestyle = '-')
axs[0].plot(d[:,0], d[:,1], label = 'in', color = 'black', linestyle = '-.')    
axs[0].plot(d[:,0], d[:,1], label = 'out', color = 'black', linestyle = ':')
