...
for k in range(len(ph)):
    err3_down.append( total[1][0][k] - total[1][1][k] )
    err3_up.append( total[1][0][k] + total[1][1][k] )
    err4_down.append( total[1][2][k] - total[1][3][k] )
    err4_up.append( total[1][2][k] + total[1][3][k] )
    
    err1_down.append( total[0][0][k] - total[0][1][k] )
    err1_up.append( total[0][0][k] + total[0][1][k] )
    err2_down.append( total[0][2][k] - total[0][3][k] )
    err2_up.append( total[0][2][k] + total[0][3][k] )
    
fig = plt.figure()
fig1 = plt.plot(ph, total[0][0], label = 'Pos, Al', color = 'royalblue', marker ='o', linestyle = ':') 
fig11 = plt.fill_between(ph, err1_down, err1_up, color='lightskyblue', alpha=0.3)

fig2 = plt.plot(ph, total[0][2], label = 'Pos, Si', color = 'royalblue', marker ='o', linestyle = '-')  
fig22 = plt.fill_between(ph, err2_up, err2_down, color='lightskyblue', alpha=0.2)

fig3 = plt.plot(ph, total[1][0], label = 'Neg, Al', color = 'darkorange', marker ='o', linestyle = ':' ) 
fig33 = plt.fill_between(ph, err3_up, err3_down, color='orange', alpha=0.2)

fig4 = plt.plot(ph, total[1][2], label = 'Neg, Si', color = 'darkorange', marker ='o', linestyle = '-')  
fig44 = plt.fill_between(ph, err4_up, err4_down, color='orange', alpha=0.2)
...
plt.show() 
fig.savefig('fig/titration_neg_pos_40_rev1.pdf')
'''
